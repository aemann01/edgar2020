...
####CHANGE THESE####
PATH="/home/lymelab/mann/edgar/" #CHANGE ME to your working directory
RAW="/home/lymelab/Desktop/Edgar_Heather/032020" #CHANGE ME to where your raw fastq files are
...
FWD.RC <- dada2:::rc(FWPRI)
REV.RC <- dada2:::rc(RVPRI)
# Trim FWD and the reverse-complement of REV off of R1 (forward reads)
R1.flags <- paste("-g", FWPRI, "-a", REV.RC) 
# Trim REV and the reverse-complement of FWD off of R2 (reverse reads)
R2.flags <- paste("-G", RVPRI, "-A", FWD.RC) 
